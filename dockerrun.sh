...
##====> for newrelic
#(cd /opt;nohup java  -Dserver.port=${server_port} -javaagent:/opt/newrelic/newrelic.jar -jar /opt/restapp.jar > /var/log/rest_new_service.log 2>&1 &)

tail -f /var/log/rest_new_service.log
#====> for datadog
